...
object Dependencies {
  ...
  lazy val scalaCollectionCompat = "org.scala-lang.modules" %% "scala-collection-compat" % "2.7.0"
  ...
  def refined(scalaVersion: String): ModuleID =
    scalaVersion match {
      ...
      case _                         => "eu.timepit" %% "refined" % "0.10.1"
    }
  ...
  lazy val tweakFlow              = "com.twineworks"          % "tweakflow"                % "1.4.2"
